...
gh release download v0.4.0 --repo santosr2/terratidy
...
gh release download v0.4.0 --repo santosr2/terratidy -p 'checksums.txt*'

# Verify the signature, pinning the release workflow and the tag it ran on
cosign verify-blob checksums.txt \
  --bundle checksums.txt.bundle \
  --certificate-identity 'https://github.com/santosr2/TerraTidy/.github/workflows/release.yml@refs/tags/v0.4.0' \
...
gh release download v0.4.0 --repo santosr2/terratidy -p '*.sbom.json'
```
