...
- **Private reports** (preferred for anything sensitive): use [GitHub's private reporting
  form](https://github.com/santosr2/TerraTidy/security/advisories/new). Reports submitted there are visible only to the
  maintainer, [@santosr2](https://github.com/santosr2). The form is labelled for security reports, but conduct reports
  are equally welcome through it — it is the project's private channel.
- **Non-sensitive matters**: open a [GitHub issue](https://github.com/santosr2/TerraTidy/issues).

TerraTidy is currently maintained by a single person, so "Community Moderators" below means the maintainer,
[@santosr2](https://github.com/santosr2). If a report concerns the maintainer directly and you would prefer to escalate
outside the project, you may contact [GitHub Support](https://support.github.com/contact/report-abuse).
