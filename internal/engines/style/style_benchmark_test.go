...
func BenchmarkStyleEngine_AllRulesEnabled(b *testing.B) {
	...
	allRules := map[string]RuleConfig{
		...
		"style.data-name-convention":            {Enabled: config.BoolPtr(true)},
		"style.variable-name-convention":        {Enabled: config.BoolPtr(true)},
		"style.output-name-convention":          {Enabled: config.BoolPtr(true)},
		"style.local-name-convention":           {Enabled: config.BoolPtr(true)},
